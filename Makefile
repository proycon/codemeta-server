...
test: codemetapy software.ttl
	codemetapy --validate software.ttl --baseuri http://localhost:8080/ codemetapy > /tmp/codemetapy.codemeta.json
	codemetapy --validate software.ttl --baseuri http://localhost:8080/ codemeta_server > /tmp/codemeta_server.codemeta.json
	codemetapy --validate software.ttl --baseuri http://localhost:8080/ codemetapy/tests/labirinto.package.json > /tmp/labirinto.codemeta.json
	codemetapy --validate software.ttl --baseuri http://localhost:8080/ codemetapy/tests/widoco.pom.xml > /tmp/widoco.codemeta.json
	codemetapy --validate software.ttl --baseuri http://localhost:8080/ codemetapy/tests/frog.codemeta.json > /tmp/frog.codemeta.json
